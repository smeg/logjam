...
set :repository, "file:///var/svn/logjam"
set :deploy_to, "/home/production/logjam"
set :application_port, 9005
...
# ssh_options[:port] = 25
ssh_options[:keys] = %w(/home/production/.ssh/id_dsa)
...
task :after_symlink do
  ENV['SHARED_PATH']  = "#{deploy_to}/shared" unless ENV['SHARED_PATH']
  cp "#{ENV['SHARED_PATH']}/database.yml",  "#{current_path}/config"

  chmod 0600, "#{current_path}/config/database.yml"
  mkpath "#{current_path}/tmp/sockets"
end
